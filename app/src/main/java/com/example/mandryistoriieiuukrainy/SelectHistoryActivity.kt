...
class SelectHistoryActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySelectHistoryBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySelectHistoryBinding.inflate(layoutInflater)
